 var withinViewport = (function() {
      ...
      if (window.requestAnimationFrame && document.documentElement.classList) {
        ...
        var revealer = document.querySelectorAll('.showcase-img');
        ...
        var toggleElement = function() {
          for (var i = 0; i < revealer.length; i++) {
            if (checkVisibility(revealer[i])) {
              revealer[i].classList.add('animate__animated', 'animate__zoomIn');
            } else {
              revealer[i].classList.remove('animate__animated', 'animate__zoomIn');
            }
          }
     
          for (var i = 0; i < slidein.length; i++) {
            if (checkVisibility(slidein[i])) {
                slidein[i].classList.add('animate__animated', 'animate__slideInLeft');
            } else {
                slidein[i].classList.remove('animate__animated', 'animate__slideInLeft');
            }
          }
          
          for (var i = 0; i < fade.length; i++) {
            if (checkVisibility(fade[i])) {
              fade[i].classList.add('animate__animated', 'animate__fadeIn');
            } else {
              fade[i].classList.remove('animate__animated', 'animate__fadeIn');
            }
          }
        };
